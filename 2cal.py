...
# function to calculate trigonometric number of an angle
def trig_sin():
    global calc_operator
...
text_display = Entry(tk_calc, font=('san-serif', 20,'bold'), textvariable=text_input,
...
contangent = Button(tk_calc, button_params, text='cot',
...
ten_power = Button(tk_calc, button_params, text='10^x', font=('sans-serif',15,'bold'),
...
ln_base = Button(tk_calc, button_params, text='ln',
...
rigth_par = Button(tk_calc, button_params, text=')',
...
delete_one = Button(tk_calc, bd=5, fg='#000', font=('sans-serif',20,'bold'),
                    text='DEL', command=button_delete_one, bg='#db701f').grid(row=6,column=3,sticky="nsew")
